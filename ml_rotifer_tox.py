...
def applicability_domain(x_test_normalized, x_train_normalized):
    ...
    leverage_train=np.asarray(leverage_train).ravel()
    ...
    std_residual_train = np.asarray(std_residual_train).ravel()
...
def applicability_domain2(x_test_normalized2, x_train_normalized2):
    ...
    leverage_train2=np.asarray(leverage_train2).ravel()
    ...
    std_residual_train2 = np.asarray(std_residual_train2).ravel()
...
def predictions2(loaded_model2, loaded_desc2, df_test_normalized2):
    ...
    with st.spinner('CALCULATING PREDICTIONS (STEP 2 OF 3)...'):
        ...
        final_file2["Confidence"] = final_file2["Confidence"].astype("object")
